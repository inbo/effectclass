...
The `effectclass` package provides a functions to classify effects in a stable and transparent manner.
...
We split the `negative effect` in a `strong negative effect`, `moderate negative effect` and `negative effect` using the similar rules as for the `positve effect`.

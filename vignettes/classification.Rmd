...
Use the `type = "markdown"` argument of `format()` to convert the classifaction as verbatim text, which preserves the double hyphen when rendering the document.
The `type = "arrow"` argument replaces `+` by an up arrow, `-` by a down arrow and `~` by a double headed arrow.
...
tab$arrow <- format(tab$class, type = "arrow")
kable(
  tab, 
